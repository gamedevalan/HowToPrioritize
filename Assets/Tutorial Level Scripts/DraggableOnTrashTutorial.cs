...
public class DraggableOnTrashTutorial : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        trashCanPosition = MainTutorial.trashCan.position;
    ...
    {
        if (collision.gameObject.name == MainTutorial.trashCan.gameObject.name)
        {
            onTrash = true;
        }
    }
